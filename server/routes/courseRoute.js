...
const { createCourse, getAllCourseDetail, updateCourse,getAllCourse, getCartDetails, updateCartDetails, deleteCartDetails, editCourseDetails } = require("../controllers/CourseCT");
