...
import { updateCourse } from "../../../../APIs/mainAPI";
  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="space-y-8 bg-white/10 p-6 rounded-md mr-5 max-w-[700px] mt-4 shadow-lg"
      >
        <div className="flex items-center space-x-3">
          <label
            htmlFor="public"
            className="text-md font-semibold text-white/80 flex items-center cursor-pointer"
          >
