...
const ViewCourse=()=>{
    ...
    return (
        ...
        transition={{ duration: 0.4, delay: 0.2, ease: [0, 0.71, 0.2, 1.01] }} className="flex font-semibold flex-col text-lg pt-2 pl-5">
        ...
        <span>/</span>
        <span className="text-yellow-500">{enrolledCourse[index].CourseName}</span>
      </div>
