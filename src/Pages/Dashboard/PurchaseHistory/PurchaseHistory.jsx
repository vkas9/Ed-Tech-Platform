...
import { getPurchaseHistory } from "../../../APIs/Authapi";
const PurchaseHistory = () => {
  ...
  return (
    ...
    <h1 className="text-3xl mb-3">Purchase History <span>({course?.purchaseHistory?.length})</span></h1>
    <div className="flex mr-5 rounded-lg overflow-x-auto items-center justify-start ">
      ...
      <div className="overflow-y-auto   mt-2 rounded-md pb-[12rem] h-[75vh]">
        {!course ? (
          ...
          course.purchaseHistory.slice().reverse().map((courseItem, index) => (
