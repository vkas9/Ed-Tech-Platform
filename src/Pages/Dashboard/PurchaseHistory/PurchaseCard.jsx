...
<span className="absolute top-1/2 left-1/2 transform -translate-x-1/2 font-bold text-center text-xl bg-white/10 p-3 rounded-xl text-red-500 -translate-y-1/2">This course is no longer available</span>
</div>}
