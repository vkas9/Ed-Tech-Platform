...
const ConfirmModal=({modalData})=>{
    ...
    return (
        <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:.2,delay:0}} onClick={modalData?.btn2Handler} className="top-0  left-0 z-[9999] flex justify-center bg-black/60 fixed w-[100vw] h-[100vh]  backdrop-blur-md">
            <div onClick={(e)=>e.stopPropagation()} className="fixed flex py-6 flex-col text-center items-center gap-3  w-[96%]  sm:w-[400px] top-[35%]   rounded-xl bg-white/10 p-2  ">
