    ...
    return (
        <motion.div variants={fadeIn} initial="initial" whileInView="animate" viewport={{
            ...
            <div className=" z-10 0  flex flex-col  mx-auto sm:text-start max-w-[30em]  ">
                <h1 className=" text-3xl lg:text-5xl text-center font-bold mb-4 md:mb-10 ">MASTER for Mastering New Technologies</h1>
                ...
                <div className={"outline-none text-2xl rounded-md mx-auto text-black   bg-yellow-500 sm:hover:bg-yellow-400 py-2 px-4  hover:cursor-pointer font-bold"} ><Link  to="/signup/i/student"> Learn More</Link></div>
            </div>
