...
const Pricing = () => {
  return <div className="container relative mx-auto  mt-[6rem] px-2 mb-5 lg:px-4 lg:mt-[8rem] ">
        ...
        <div className="flex flex-col  lg:flex-row gap-5 justify-center items-center ">
            <PricingCard title={"Full Stack"} price={"4999"} className={"text-green-600"}  description={"Fronted+Backend full course with many project"} />
            ...
            <PricingCard title={"Machine Learning"} price={"7899"}  className={"text-purple-800"} description={"Fronted+Backend full course with many project"} />
        </div>
