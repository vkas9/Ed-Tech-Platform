...
const Pricing = () => {
  ...
  return <div className=" relative mx-auto  mt-[6rem] px-2 mb-5 lg:px-4 lg:mt-[8rem] ">
        <div className="max-w-[1100px] w-full  mx-auto">
            <h1 className=" py-3 font-extrabold mb-[5rem] text-4xl lg:text-5xl 2xl:text-6xl text-center  bg-gradient-to-br   md:bg-gradient-to-b from-white via-white to-black/20 bg-clip-text text-transparent">Become the Master of High Demanding Technology </h1>
        </div>
