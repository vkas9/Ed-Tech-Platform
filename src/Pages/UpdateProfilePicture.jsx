...
import { updateDisplayProfile } from "../APIs/mainAPI";
      ...
      <Formik initialValues={initialValues} onSubmit={handleSubmit}>
        {({ isSubmitting }) => (
          <Form
            ...
            className="bg-gradient-to-tr h-fit   mt-[6rem] sm:mt-[0rem] from-[#010035] via-gray-950/100 to-black   p-4 max-w-[500px] w-[500px] rounded-md"
          >
