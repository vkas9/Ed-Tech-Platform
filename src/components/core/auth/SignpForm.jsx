...
const SignupForm = () => {
  ...
  return (
    ...
    <h1 className="text-[2.5rem]  overflow-hidden mt-[1rem] mx-2 xs:-mt-[2rem] sm:-mt-[1rem] md:text-[4em]  bg-gradient-to-r from-red-500 via-purple-400 to-blue-500 bg-clip-text text-transparent font-bold text-center ">MASTER WORLD</h1>
      <Formik
